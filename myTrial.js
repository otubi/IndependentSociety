...
//=================================================== ORDER ==========================================================
  ...
  // Select the container (do NOT empty it)
   ...
   function fetchAllOrderForUpdate() {
    ...
    //     fetch(`${API_URL_ORDERS}/${userId}`, { method: "DELETE" })
    //         .then(() => {
    //             $resultsContainer.innerHTML = `<p style="color:green;">Order ${userId} deleted successfully.</p>`;
    //             fetchAllOrderForUpdate();
    //         })
    //         .catch(() => {
    //             $resultsContainer.innerHTML = `<p style="color:red;">Failed to delete order ${userId}.</p>`;
    //         });
    // }
